...
<div>
    ...
    <!-- New comment form -->
    <div
        class="fixed bottom-0 left-0 lg:left-[32%] right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-white/10 z-50">
    ...
    <template id="templateMensagem">
        <li class="flex mb-2">
            <div class="max-w-[70%] break-all mensagem-container">

                <div class="px-3 py-2 rounded-lg text-sm mensagem-box">
                    <span class="mensagem-body"></span>
                </div>

                <div class="text-[10px] text-gray-400 mt-1 mensagem-time"></div>
