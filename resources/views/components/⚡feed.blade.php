...
<div>
    ...
    <!-- New comment form -->
    <div class="fixed bottom-0 left-0 lg:left-72 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-white/10 z-50">
        <div class="px-4 py-3 flex gap-x-3">
            <img src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?..." class="size-6 flex-none rounded-full" />

            <form action="#" class="relative flex-auto">
                <div class="overflow-hidden rounded-lg outline-1 outline-gray-300 focus-within:outline-2 focus-within:outline-indigo-600 dark:bg-white/5">
        <textarea
            id="comentario"
            rows="5"
